...
- Vercel preview deployment and Vercel Preview Comments passed on a recent branch head, but the latest checked PR head is blocked by Vercel's account build-rate limit and lacks fresh preview-deploy evidence.
