...
- task-detail notes for human context, decisions, links, and future agent handoff context, with demo localStorage persistence, authenticated owned-task note routes, a copyable task handoff brief, and MCP/ChatGPT Actions support for external agents to append reviewable task notes or bounded agent-result notes
