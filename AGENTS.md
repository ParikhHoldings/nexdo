...
- narrowed browser-visible profile columns and direct profile self-updates so clients can read/edit bounded profile preferences without direct access to Stripe IDs, raw/hash API-key material, quota internals, or billing mutation fields
