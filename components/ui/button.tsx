...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      ...
      ghost:
        'hover:bg-zinc-800 text-zinc-400 hover:text-zinc-100 focus:ring-zinc-600',
      danger:
        'bg-red-600 hover:bg-red-500 text-white focus:ring-red-500',
      outline:
        'border border-zinc-700 hover:bg-zinc-800 text-zinc-300 hover:text-zinc-100 focus:ring-zinc-600',
    }
