...
- verified PR #3 Web rails, Vercel preview deployment, and Vercel Preview Comments on the latest checked PR head; later heads still need fresh PR-check evidence
