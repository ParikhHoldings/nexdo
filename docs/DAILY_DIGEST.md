...
- Verified the login-email normalization and docs-refresh heads through local rails, GitHub Web rails, Vercel preview deployment, and clean PR merge-state inspection.
