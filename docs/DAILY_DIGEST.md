...
- Verified PR #3 Web rails and Vercel preview deployment after the import schedule metadata rail; documented that some documentation-only pushes can still hit the Vercel account build-rate limit.
