...
- `npm run typecheck`
- `npm run build`
- `npm run test:e2e` including logged-out task capture/agent output, auth guardrails, MCP/OpenAPI/Stripe guardrails, demo CSV file import, and free-plan API-key UI gating
