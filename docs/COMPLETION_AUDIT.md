...
- `npm run typecheck`
- `npm run build`
- `npm run test:e2e` including logged-out task capture/agent output, demo briefing refresh, auth guardrails, MCP/OpenAPI/Stripe guardrails, demo CSV file import, login demo-mode entry, free-plan API-key UI gating, and settings tab deep links
