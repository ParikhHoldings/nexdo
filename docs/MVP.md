...
## Launch blockers
- Real Supabase migrations, auth, RLS, task CRUD, task-note CRUD, profile insert/read/update grants and content bounds, task/task-note column grants and content bounds, quota, uniqueness, and audit smoke.
