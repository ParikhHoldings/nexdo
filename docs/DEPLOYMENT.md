...
- Supabase: apply migrations to a real project, create a user, verify profile creation, RLS, task CRUD, and service-role RPCs.
...
- MCP/ChatGPT Actions: generate a real API key and run authenticated list/create/update/complete/search/briefing/get-task calls against real task data.
