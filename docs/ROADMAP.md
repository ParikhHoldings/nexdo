...
- `npm ci`, `npm run lint`, `npm run typecheck`, `npm run build`, `npm run test:e2e` with 87 tests, dependency audit, and the technical launch smoke partial passed locally on 2026-05-17.
